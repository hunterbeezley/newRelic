#!/usr/bin/env python3
"""
takes in a json of user Id's in the format shown 'example_users_dict.json', 
use companion script 'filterOldUsers.py' to narrow users by date threshold and/or generate a json dict in the expected format.
deletes users via NerdGraph API.
"""
...
class NewRelicUserDeleter:
    ...
    def delete_user(self, user_id: str) -> DeletionResult:
        ...
        Returns DeletionResult with success status and/or any error message.
        """
        mutation = """
        mutation {
...
def load_api_key(config_path: str = None) -> str:
    ...
    raise ValueError(
        "womp womp. API key not found. Please either:\n"
...
def main():
    """Main function"""
    print("New Relic Mass Delete Users Script")
    print("="*60)
